      ...
      <nav className="fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-slate-200/50 shadow-sm">
        <div className="flex items-center justify-between px-6 h-16 w-full max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a className="text-sm font-medium text-primary font-semibold transition-colors duration-150" href="#">Home</a>
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="bg-primary text-white px-5 py-2 rounded-full text-sm font-bold shadow-sm hover:opacity-90 transition-all active:scale-95">
              Start Learning
            </button>
          </div>
        </div>
        ...
        <section className="relative overflow-hidden pt-24 pb-20 md:pt-40 md:pb-32 px-6">
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="w-full sm:w-auto clinical-gradient text-white px-10 py-5 rounded-full text-lg font-bold shadow-xl hover:shadow-primary/20 transition-all active:scale-95 flex items-center justify-center gap-2">
                Start Learning
